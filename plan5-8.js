  ...
  weeks: [
    // Tuần 5
    {
      ...
      days: [
        ...
        { day_label: "Thứ 7", tasks: [
            { skill: "Từ vựng 📚", items: ["Ôn tập 100 từ vựng đã học trong tuần.", "Vẽ sơ đồ mô tả cách một request API hoạt động, điền các từ vựng liên quan."] },
    ...
    // Tuần 6
    {
      ...
      days: [
        ...
        { day_label: "Thứ 7", tasks: [
            { skill: "Từ vựng 📚", items: ["Ôn tập 100 từ vựng đã học trong tuần.", "Nhóm các từ vào các kịch bản: giving feedback, negotiation, conflict resolution."] },
    ...
    // Tuần 7
    {
      ...
      days: [
        ...
        { day_label: "Thứ 7", tasks: [
            { skill: "Từ vựng 📚", items: ["Ôn tập 100 từ vựng đã học trong tuần.", "Chọn một kỹ thuật (story mapping, decision table...) và giải thích nó bằng các từ đã học."] },
    ...
    // Tuần 8
    {
      ...
      days: [
        ...
        { day_label: "Thứ 7", tasks: [
            { skill: "Từ vựng 📚", items: ["Ôn tập 100 từ vựng đã học trong tuần.", "Vẽ sơ đồ kết nối các khái niệm: Open Banking, P2P Lending, WealthTech."] },
